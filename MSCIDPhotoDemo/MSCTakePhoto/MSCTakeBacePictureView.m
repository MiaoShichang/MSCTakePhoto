...
@interface MSCTakeBacePictureView ()
...
@implementation MSCTakeBacePictureView
...
- (void)makeupUI
{
    ...
    self.headImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"mine_kaluli_fanmian"]];
...
- (void)layoutSubviews
{
    ...
    self.headImageView.frame = CGRectMake(cropRect.origin.x+117*scale, cropRect.origin.y+24*scale, 87*scale, 77*scale);
}
